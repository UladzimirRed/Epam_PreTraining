package by.epam.pretraining.task4.aggregation_and_composition.exercise4;
...
public class Main {
    public static void main(String[] args) {
        ...
        Client client = new Client("Neo", " Raider");

        Account checking = new Account(823415L, Type.CHECKING, -1234.05d);
