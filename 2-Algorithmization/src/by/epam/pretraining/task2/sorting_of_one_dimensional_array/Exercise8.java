...
/**
 * Даны дроби p1/q1, p2/q2, ..., pn/qn (pi, qi - натуральнае). Составить прог-
 * рамму, которая приводит эти дроби к общему знаменателю и упорядочивает их в
 * порядке возрастания.
 */
...
public class Exercise8 {
    ...
    private static void setCommonDenominator (Fraction [] array) {
        ...
        for (Fraction element : array) {
            element.numer *= commonDenominator / element.denom;
